...
local wantedPlayers = MenuV:CreateMenu(false, "Wanted players", "centerright", 0, 0, 0, 'size-150', 'none', 'menuv', 'playermenu-wantedplayers')
local wantedPlayer = MenuV:CreateMenu(false, "Wanted", "centerright", 0, 0, 0, 'size-150', 'none', 'menuv', 'playermenu-wantedplayer')
local factions = {}
